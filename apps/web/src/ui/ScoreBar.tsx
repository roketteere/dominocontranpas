    ...
    return (
        <div className="flex items-center justify-between rounded-xl border border-pr-coal-soft bg-pr-coal-soft/40 px-4 py-2 text-pr-ivory">
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-baseline gap-2">
                    <span className="rounded bg-pr-blue px-1.5 py-0.5 text-[10px] font-bold text-pr-white">
                        A
                    </span>
                ...
                <div className="flex items-baseline gap-2">
                    <span className="rounded bg-pr-red px-1.5 py-0.5 text-[10px] font-bold text-pr-white">
                        B
                    </span>
