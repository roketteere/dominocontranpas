...
export const STRINGS: Record<Lang, Record<StringKey, string>> = {
    es: {
        ...
        helpCapicua: "Capicu: ganas con una ficha que pega por los dos extremos. +25 puntos.",
    ...
    en: {
        ...
        helpCapicua: "Capicu: win by playing a tile that fits both open ends. +25 points.",
